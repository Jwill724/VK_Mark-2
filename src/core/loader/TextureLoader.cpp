...
//				fmt::format("[loadImage] fastgltf::visitor fallback: unsupported m_image source type: {}\n", typeid(arg).name()));
//		},
//
...
//	}, image.data);
//
//	// If any of the attempts to load the data failed, we haven't written the m_image.
//	if (newImage.image == VK_NULL_HANDLE) {
//		JobSystem::Log(ctx.threadID, fmt::format("[loadImage] FAILED: No valid m_image allocated for '{}'\n", image.name));
//		return {};
//	}
//	else {
//		//JobSystem::Log(ctx.threadID, fmt::m_format("[loadImage] SUCCESS: Allocated m_image for '{}'\n", m_image.name));
//		return newImage;
//	}
//}
//
