...
void CommandBuffer::recordDeferredCmd(std::function<void(VkCommandBuffer)>&& function, VkCommandPool cmdPool, QueueType type, VkDevice device) {
	VkCommandBuffer cmd = createCommandBuffer(device, cmdPool);
