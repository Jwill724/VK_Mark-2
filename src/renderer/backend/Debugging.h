...
private:
	...
	inline static bool m_consoleLogResourceTrackingEnabled    = false; // bindless descriptor print info, buffer/m_image creation and destructions
#endif

	inline static bool m_gpuTimingEnabled                     = false;  // tracks and measures gpu pass exeuction for performance analysis (tracy profiler)
};
