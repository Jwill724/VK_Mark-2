...
//			const IndirectDrawRange& inputRange = frameCtx.m_csmDrawRange[cascadeIndex];
...
//
//			if (isGPUAccelOn) {
//				BufferBarriers::TransferReleaseOnCompute(cmd, frameCtx.m_addressTable_GPU);
//			}
//			else {
//				BufferBarriers::TransferReleaseOnGraphics(cmd, frameCtx.m_addressTable_GPU);
//			}
//		}
//
...
//				&indirectDrawsCpy);
//
//			BufferBarriers::TransferReleaseOnGraphics(cmd, frameCtx.m_visibleInstances_GPU);
//			BufferBarriers::TransferReleaseOnIndirect(cmd, frameCtx.m_indirectDraws_GPU);
//		}
//
...
//
//			BufferBarriers::TransferReleaseOnGraphics(cmd, frameCtx.m_transforms_GPU);
//
//			if (isTemporalValid) {
//				BufferBarriers::TransferReleaseOnGraphics(cmd, frameCtx.m_prevTransforms_GPU);
//			}
//		}
//
//		if (!lights.empty() && frameCtx.m_bLightsBufferUploadNeeded) {
...
//				&lightCpy);
//
//			BufferBarriers::TransferReleaseOnGraphics(cmd, frameCtx.m_lights_GPU);
//		}
//
